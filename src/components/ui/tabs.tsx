  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "group-data-[variant=primary]/tabs-list:data-active:bg-primary group-data-[variant=primary]/tabs-list:data-active:text-primary-foreground group-data-[variant=primary]/tabs-list:data-active:border-transparent group-data-[variant=primary]/tabs-list:data-active:shadow-sm dark:group-data-[variant=primary]/tabs-list:data-active:bg-primary dark:group-data-[variant=primary]/tabs-list:data-active:text-primary-foreground",
        ...
        "group-data-[variant=line]/tabs-list:after:bg-primary group-data-[variant=line]/tabs-list:data-active:text-primary group-data-[variant=line]/tabs-list:data-active:font-semibold dark:group-data-[variant=line]/tabs-list:data-active:text-primary",
        className
      )}
      {...props}
    />
